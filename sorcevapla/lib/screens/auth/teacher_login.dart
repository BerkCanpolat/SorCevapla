...
class _TeacherLoginState extends State<TeacherLogin> {
  ...
  void _login() async{
    ...
    if(isValidate){
      ...
      if(isLogined){
        Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => TeacherHome(),), (route) => false);
      }
    }
    _changLoading();
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text('Öğretmen',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
